...
void menu_register(void)
{
	...
	while(1) {
		...
		switch (key) {
			case '0':
				g_event_type = ASM_EVENT_SHARE_MMPLAYER;
				break;
			case '1':
				g_event_type = ASM_EVENT_SHARE_MMCAMCORDER;
				break;
			case '2':
				g_event_type = ASM_EVENT_SHARE_MMSOUND;
				break;
			case '3':
				g_event_type = ASM_EVENT_SHARE_OPENAL;
				break;
			case '4':
				g_event_type = ASM_EVENT_SHARE_AVSYSTEM;
				break;
			case '5':
				g_event_type = ASM_EVENT_SHARE_FMRADIO;
				break;
			case '6':
				g_event_type = ASM_EVENT_EXCLUSIVE_MMPLAYER;
				break;
			case '7':
				g_event_type = ASM_EVENT_EXCLUSIVE_MMCAMCORDER;
				break;
			case '8':
				g_event_type = ASM_EVENT_EXCLUSIVE_MMSOUND;
				break;
			case '9':
				g_event_type = ASM_EVENT_EXCLUSIVE_OPENAL;
				break;
			case 'a':
				g_event_type = ASM_EVENT_EXCLUSIVE_AVSYSTEM;
				break;
			case 'b':
				g_event_type = ASM_EVENT_EXCLUSIVE_FMRADIO;
				break;
			case 'c':
			...
			case 'i':
				...
				break;
			case 'j':
				g_event_type = ASM_EVENT_RICH_CALL;
				break;
			case 'k':
	...
	while(1) {
		...
		switch (key) {
			...
			case '6':
				...
				break;
			case '7':
				g_resource |= ASM_RESOURCE_EAR_SPK_PATH;
				break;
			case '8':
				g_resource |= ASM_RESOURCE_SVR;
				break;
			case '9':
				g_resource |= ASM_RESOURCE_VOICECONTROL;
				break;
			case 'a':
				g_resource |= ASM_RESOURCE_RESUMPTION_TAG;
				break;
			case 'r':
	...
	while(1) {
		...
		switch (key) {
			...
			case '5':
				...
				break;
			case '6':
				g_asm_state = ASM_STATE_PAUSE_BY_APP;
				break;
			case 'q':
				return;
			default :
	...
	while(1) {
		...
		switch (key) {
			...
			case '2':
				...
				break;
			case '3':
				g_sub_session_type = ASM_SUB_SESSION_TYPE_VOICE_ANSWER_PLAY;
				break;
			case '4':
				g_sub_session_type = ASM_SUB_SESSION_TYPE_VOICE_ANSWER_REC;
				break;
			case '5':
			...
			case '8':
				...
				break;
			case '9':
				g_sub_session_type = ASM_SUB_SESSION_TYPE_RECORD_STEREO_FOR_INTERVIEW;
				break;
			case 'a':
				g_sub_session_type = ASM_SUB_SESSION_TYPE_RECORD_STEREO_FOR_CONVERSATION;
				break;
			case 'b':
